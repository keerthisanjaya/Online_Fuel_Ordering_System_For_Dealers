   ...
   <div class="row mb-5">
      <div class="col-md-12 mb-3">
		...
		<!-- error message end--> 
               ...
               <h5 class="card-title">Vehicle Calibration Certificate Details</h5>
			   <div class="float-right">
			   		   <a href="<?php echo base_url();?>index.php/vehiclecalibrationcertificate/insert" class="btn btn-info"><i class="fa fa-pencil"></i> Add New Calibration Certificate</a>
			   </div>
			   <br><br>
               <table id="vehicle_calibration_certificate" class="display nowrap" style="width:100%" >
                  ...
                  <tbody>
						...
						<tr>
							...
							<td><a href="<?php echo base_url() . $row->document_path; ?>" target="_blank">View Document</a></td>
							<td>
								<?php
							...
							<td>
								<a href="<?php echo base_url();?>index.php/vehiclecalibrationcertificate/edit/<?=$row->idvehicle_calibration_certificate; ?>" class="btn btn-sm btn-primary">Edit</a>
								<a href="<?php echo base_url();?>index.php/vehiclecalibrationcertificate/delete/<?=$row->idvehicle_calibration_certificate; ?>" class="btn btn-sm btn-danger">Delete</a>
							</td>
