            ...
            <div class="authentication-inner">
               ...
               <div class="card">
                  <div class="card-body">
                     ...
                     <p class="mb-4"></p>
                     <form id="formAuthentication" class="mb-3" action="<?php echo base_url();?>otp/verify" method="POST">
                        <div class="mb-3">
                           <label for="otp" class="form-label">OTP</label>
                           <input type="text" class="form-control" id="otp" name="otpcode" value="" placeholder="Enter your otp" autofocus="">
                        </div>
