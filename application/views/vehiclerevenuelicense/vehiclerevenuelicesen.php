<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <!-- error message start-->
      ...
      <h5 class="card-header">Add Vehicle Revenue License Details</h5>
      
      <hr class="my-0">
      <div class="card-body">
         <form method="POST" action="<?php echo base_url();?>index.php/vehiclerevenuelicense/save">
              ...
              <input type="hidden" id="idvehicle_revenue_license" name="idvehicle_revenue_license" class="form-control" placeholder="Idvehicle revenue license" maxlength="11" required>
                            <div class="col-md-12">
								<div class="form-group mb-3">
									...
									<input type="text" id="vehicle_revenue_license_name" name="vehicle_revenue_license_name" class="form-control" placeholder="Vehicle revenue license name" minlength="0"  maxlength="45" required>
								</div>
							</div>
                            <div class="col-md-12">
								<div class="form-group mb-3">
									<label for="vehicle_revenue_license_issue_date" class="form-label"> Vehicle revenue license issue date: </label>
									<input type="date" id="vehicle_revenue_license_issue_date" name="vehicle_revenue_license_issue_date" class="form-control" dateISO="true" required>
								</div>
							</div>
                            <div class="col-md-12">
								<div class="form-group mb-3">
									<label for="vehicle_revenue_license_expiry_date" class="form-label"> Vehicle revenue license expiry date: </label>
									<input type="date" id="vehicle_revenue_license_expiry_date" name="vehicle_revenue_license_expiry_date" class="form-control" dateISO="true" required>
								</div>
							</div>
