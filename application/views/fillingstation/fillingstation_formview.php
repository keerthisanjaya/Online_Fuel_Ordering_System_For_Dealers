	...
	<div class="col-md-6">
		...
		<div class="form-group mb-3">
			...
			<input type="text" id="fillingstation_name" name="fillingstation_name" class="form-control"
				placeholder="Fillingstation name" minlength="0" maxlength="45" required>
		</div>
		...
		<div class="form-group mb-3">
			...
			<input type="number" id="numberoffueldespencers" name="numberoffueldespencers"
				class="form-control" placeholder="Numberoffueldespencers" minlength="0" maxlength="11" required>
		</div>
		...
		<div class="form-group mb-3">
			...
			<input type="number" id="capacityofpetroltank" name="capacityofpetroltank" class="form-control"
				placeholder="Capacityofpetroltank" minlength="0" maxlength="11" required>
		</div>
	</div>
	...
	<div class="col-md-6">
		<div class="form-group mb-3">
			...
			<input type="number" id="capacityofdieseltank" name="capacityofdieseltank" class="form-control"
				placeholder="Capacityofdieseltank" minlength="0" maxlength="11" required>
		</div>
